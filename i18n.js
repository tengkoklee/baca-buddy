...
const STR = {
  ...
  tp_start_drill: { en: "Jayden's turn!", zh: '开始练习！', ms: 'Giliran Jayden!' },
  tp_set_words:   { en: "Set teacher's words", zh: '设置老师的词语', ms: 'Tetapkan perkataan cikgu' },
  tp_src_teacher: { en: "📋 Teacher's words ({n})", zh: '📋 老师的词语（{n} 个）', ms: '📋 Perkataan cikgu ({n})' },
  tp_src_topic:   { en: '📚 Practice words from your topics', zh: '📚 用你选的主题词语练习', ms: '📚 Perkataan latihan daripada topik anda' },
